    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Complete your store details as part of the seller application.
        </p>
      </div>
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Store className="h-5 w-5 text-primary" /> {seller.business.shopName || "Your store"}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Store profile, address, bank details and documents are completed in the registration
            steps. Current status:{" "}
            <span className="font-medium text-foreground">{seller.status}</span>.
          </p>

...
function ProfilePage() {
  ...
  const sections: Array<[string, Array<[string, string]>]> = [
    ...
    ["Address", [
      ["Shop address", `${seller.address.shopAddress}, ${seller.address.city}, ${seller.address.state} - ${seller.address.pincode}`],
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link to="/register"><Button variant="outline">Edit registration</Button></Link>
      </div>

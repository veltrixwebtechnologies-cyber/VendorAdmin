        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Complete the 7-step registration and submit your application. Products, orders and
              seller tools unlock after admin approval.
            </p>
            <div className="flex flex-wrap gap-2">
              ...
              <Link to="/seller/store">
                <Button variant="outline">Store setup</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
  ...
  const tiles = [
    {
      ...
      icon: ShoppingBag,
      tone: stats.newOrders > 0 ? "primary" : "muted",
    },
    {
      to: "/seller/products",
    ...
    },
    {
      ...
      icon: Box,
      tone: stats.outOfStock > 0 ? "destructive" : "muted",
    },
    {
      ...
      value: stats.revenue,
      currency: true,
      hint: "Payouts calculated weekly",
      icon: CheckCircle2,
      tone: "muted",
    },
  ] as const;
    ...
    <Card className="border-destructive">
      <CardContent className="flex items-start gap-3 py-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            {reason || "Your application was rejected. Please review and resubmit."}
          </p>
          <div className="mt-3">
    ...
    <Card className="border-accent">
      <CardContent className="flex items-start gap-3 py-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            {message || "Admin has requested more information about your application."}
          </p>
          <div className="mt-3">
            <Link to="/register" search={{ step: 6 }}>
              <Button variant="outline">
      ...
      <Card className="border-success">
        <CardContent className="flex items-center gap-3 py-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              You can now set up your store and start listing products.
            </p>
          </div>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <Link to="/seller/store">
              <Button variant="outline">
                <Store className="h-4 w-4" /> Complete store profile
              </Button>
            </Link>
            <Link to="/seller/products">
              <Button>{hasProduct ? "Manage products" : "Add first product"}</Button>
            </Link>
          </div>
        </CardContent>
      </Card>

...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black tracking-tight sm:text-3xl">Platform Settings</h1>
        <p className="text-sm text-muted-foreground">Marketplace-wide configuration.</p>
      </div>
      {q.isLoading ? (

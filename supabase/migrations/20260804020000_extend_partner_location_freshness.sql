-- Allow a temporary browser GPS outage without making partners disappear.
-- Coordinates are still required; only the freshness window is extended.
...
BEGIN
  ...
  WHERE p.status = 'approved'
    ...
    -- GPS can be temporarily unavailable on a phone or laptop. Keep the
    -- partner eligible for 30 minutes while the client retries location.
